...
function loadParagraph(){
    ...
    // getting random item from the paragraphs array, splitting all characters of it, adding each character inside span and then adding this span inside span and then adding this span inside p tag
...
function initTyping(){
    ...
    if(charIndex < characters.length  - 1 && timeleft > 0){
        ...
        // if user hasn't entered any character pressed backspace
        if(typedChar==null){
